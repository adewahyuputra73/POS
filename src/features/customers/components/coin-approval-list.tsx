...
export function CoinApprovalList({ approvals, onApprove, onReject, onClose }: CoinApprovalListProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[80vh] overflow-y-auto p-6 relative animate-in slide-in-from-bottom-4 duration-300">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="font-semibold text-gray-900">Approval Koin</h3>
            <p className="text-xs text-gray-500">{pendingApprovals.length} permintaan menunggu persetujuan</p>
          </div>
        </div>
        ...
        {pendingApprovals.length > 0 ? (
          <div className="space-y-3 mb-6">
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Menunggu Persetujuan</p>
              ...
              <div key={a.id} className="flex items-center justify-between bg-orange-50/50 border border-orange-100 rounded-xl p-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-sm font-medium text-gray-900">{a.customerName}</span>
          ...
          <div className="text-center py-8 mb-6">
            ...
            <p className="text-sm text-gray-500">Tidak ada permintaan yang menunggu</p>
          </div>
        )}
        ...
        {pastApprovals.length > 0 && (
          <div className="space-y-3">
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Riwayat</p>
            {pastApprovals.map(a => (
              <div key={a.id} className="flex items-center justify-between bg-gray-50 rounded-xl p-4">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-sm font-medium text-gray-700">{a.customerName}</span>
                    <Badge
