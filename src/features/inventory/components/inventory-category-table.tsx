              ...
              <TableCell>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    {category.isDefault && (
                      <span className="ml-2 px-2 py-0.5 rounded text-xs bg-gray-100 text-gray-500">Default</span>
                    )}
                  </div>
                </div>
              </TableCell>
              <TableCell className="text-gray-500 text-sm">{formatDate(category.updatedAt)}</TableCell>
              <TableCell>
                <div className="flex items-center justify-center">
                  <Button
                    ...
                    className="h-8 w-8 text-gray-500 hover:text-amber-600 disabled:opacity-30"
                  >
