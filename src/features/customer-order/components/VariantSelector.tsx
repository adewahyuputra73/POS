                ...
                >
                    ...
                    <div className="shrink-0 relative overflow-hidden" style={{ aspectRatio: '16/9', maxHeight: '45vw', minHeight: '140px' }}>
                        {product.images[0] ? (
                            ...
                            >
                                <span
                                    ...
                                    style={{ fontSize: 'clamp(3.5rem, 14vw, 7rem)', color: '#16A34A', opacity: 0.18 }}
                                >
                            ...
                            <div className="flex items-end gap-3 justify-between">
                                <div className="flex-1 min-w-0">
                                    <h2
                                        ...
                                        style={{ fontSize: 'clamp(1.1rem, 4vw, 1.4rem)', color: '#13182B' }}
                                    >
                                        {product.name}
                                    </h2>
                                    {product.description && (
                        ...
                        <button
                            ...
                            style={{ backgroundColor: 'rgba(0,0,0,0.45)', backdropFilter: 'blur(8px)', color: '#13182B' }}
                            aria-label="Tutup"
                        >
                            <X className="h-4 w-4" />
                        </button>
                                    ...
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        {variant.isRequired ? (
                                            ...
                                            <span
                                                ...
                                                style={{ backgroundColor: 'rgba(124,74,30,0.07)', color: '#9CA3B5' }}
                                            >
                                                Opsional
                                            </span>
                                        )}
                                        ...
                                        {variant.options.map((option) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    style={
                                                        isSelected
                                                            ? { backgroundColor: '#0E6B30', borderColor: '#22D55C' }
                                                            : { backgroundColor: '#13182B', borderColor: 'rgba(124,74,30,0.14)' }
                                                    }
                                                >
                                                    {/* Animated checkmark */}
                                                    <div
                                                    ...
                                                    <span
                                                        ...
                                                        style={{ color: isSelected ? '#92400E' : '#F8FAFC' }}
                                                    >
                                                        {option.name}
                                                    </span>
                                                    <span
                                                        className="text-[11px] font-black"
                                                        style={{ color: isSelected ? '#16A34A' : 'rgba(124,74,30,0.45)' }}
                                                    >
                            ...
                            <div>
                                ...
                                {notesOpen && (
                                    <textarea
                                        ...
                                        onFocus={e => (e.currentTarget.style.borderColor = '#22D55C')}
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{
                                ...
                                border: '1px solid rgba(34,213,92,0.20)',
                            }}
                        >
                            <button
                                ...
                                style={{ backgroundColor: 'rgba(255,255,255,0.08)', color: '#22D55C' }}
                            >
                        ...
                        <button
                            ...
                            style={{
                                backgroundColor: canConfirm ? '#22D55C' : 'rgba(245,158,11,0.5)',
                                color: '#F8FAFC',
