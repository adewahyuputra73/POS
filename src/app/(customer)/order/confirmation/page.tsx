    ...
    return (
        <>
            ...
            <div
                ...
                style={{ backgroundColor: "#FFFBF5", boxShadow: "0 -8px 40px rgba(0,0,0,0.15)" }}
            >
                {/* Handle */}
                <div
                    className="w-10 h-1.5 rounded-full mx-auto mb-6"
                    style={{ backgroundColor: "rgba(34,213,92,0.22)" }}
                />
                ...
                <div className="space-y-3">
                    <a
                        ...
                        style={{ backgroundColor: "#25D366", color: "#13182B" }}
                    >
        ...
        <div className="min-h-screen" style={{ backgroundColor: "#0A0E1F" }}>
            <div className="container mx-auto px-4 pt-16 pb-32 max-w-xl text-center">
                ...
                <div className="relative mb-10">
                    ...
                    >
                        <CheckCircle2 className="h-16 w-16 stroke-[2.5px]" style={{ color: "#F8FAFC" }} />
                    </div>
                </div>
                ...
                <p className="leading-relaxed mb-10 font-medium px-4" style={{ color: "#9CA3B5" }}>
                    Terima kasih{" "}
                    <span className="font-black" style={{ color: "#F8FAFC" }}>{customerName}</span>
                ...
                >
                    <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity pointer-events-none">
                        <Ticket className="h-40 w-40 -rotate-12" style={{ color: "#F8FAFC" }} />
                    </div>
                    <p
                    ...
                    {isDineIn && (
                        <div
                            ...
                            style={{ backgroundColor: "#0E6B30", border: "1.5px solid rgba(245,158,11,0.3)" }}
                        >
                            <div
                                className="h-8 w-8 rounded-xl flex items-center justify-center shrink-0"
                                style={{ backgroundColor: "#22D55C" }}
                            >
                                <ShoppingBag className="h-4 w-4" style={{ color: "#F8FAFC" }} />
                            </div>
                    ...
                    {isPickup && (
                        ...
                        >
                            <div
                                ...
                                style={{ backgroundColor: "#22D55C" }}
                            >
                                <Eye className="h-4 w-4" style={{ color: "#F8FAFC" }} />
                            </div>
                            <p className="text-[11px] font-bold leading-snug" style={{ color: "#92400E" }}>
                    ...
                    <div
                        ...
                        style={{ borderTop: "1px dashed rgba(34,213,92,0.18)" }}
                    >
                        <button
                            onClick={() => {
                                if (orderId) {
                ...
                <div className="space-y-3">
                    ...
                    {showWaNotif && (
                        <button
                            ...
                            style={{
                                borderColor: "rgba(34,213,92,0.4)",
                                color: "#16A34A",
                                backgroundColor: "#13182B",
                            }}
                        >
                    ...
                    <Link
                        ...
                        style={
                            backButtonLocked
                                ? { backgroundColor: "rgba(0,0,0,0.1)", color: "#606988", cursor: "not-allowed", boxShadow: "none" }
                                : { backgroundColor: "#F8FAFC", color: "#13182B", boxShadow: "0 8px 24px rgba(0,0,0,0.25)" }
                        }
                    >
                    ...
                    <p className="text-[11px] font-black uppercase tracking-widest pt-4" style={{ color: "#606988" }}>
                        Butuh bantuan?{" "}
                        {storePhone ? (
                            <a
                            ...
                            <span style={{ color: "#16A34A" }}>Hubungi Toko</span>
                        )}
                    </p>
                </div>
                ...
                {(isDineIn || isPickup || !fulfillmentType) && (
                    ...
                    >
                        ...
                        >
                            <CreditCard className="h-6 w-6" style={{ color: "#16A34A" }} />
                        </div>
                        <div className="flex-1 min-w-0">
                            <h3 className="text-sm font-black mb-1" style={{ color: "#F8FAFC" }}>
                                Bayar di Tempat
                            </h3>
                            <p className="text-[11px] font-medium leading-relaxed" style={{ color: "#9CA3B5" }}>
                                Tunjukkan nomor pesanan di atas ke meja kasir untuk melakukan pembayaran dan mengambil pesanan.
                            </p>
                        </div>
                        <ChevronRight className="h-5 w-5 mt-3 shrink-0" style={{ color: "#606988" }} />
                    </div>
                )}
            </div>
